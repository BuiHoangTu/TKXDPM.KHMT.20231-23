...
<details>
  ...
  <details>
    ...
    - Assigned tasks:
      - Đánh giá tính coupling của IPayOrderService, PayOrderService, PlaceOrderService trong file service
...
<details>
  ...
  <details>
    ...
    - Assigned tasks:
      - Đánh giá tính cohesion trong file service

    - Implementation details:
      - Pull Request(s): [Attach links to your pull requests here. You can attach multiple pull requests]()
      - Specific implementation details:
        - đánh giá tính cohesion của lớp PayOrderService và interface IPayOrderService và 1 số đề xuất để cải thiện
        - cả lớp và interface đều có tính cohesion tốt, có thể cải thiện theo đề xuất để tốt hơn
  </details>
...
<details>
  ...
  <details>
    ...
    - Assigned tasks:
      - Đánh giá tính SOLID của IPayOrderService, PayOrderService, PlaceOrderService trong file service

    - Implementation details:
      - Pull Request(s): [Attach links to your pull requests here. You can attach multiple pull requests]()
      - Specific implementation details:
        - Đánh giá tính SOLID và đề xuất cải thiện của IPayOrderService, PayOrderService, PlaceOrderService
        - hầu hết đều đảm bảo SRP tuy nhiên có thể chỉnh sửa đề cải thiện tính DIP
